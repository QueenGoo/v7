...
### INSTALL SCRIPT 
#<pre><code>apt install -y wget screen && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/QueenGoo/v7/main/premi.sh && chmod +x premi.sh && screen -S install ./premi.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget https://raw.githubusercontent.com/QueenGoo/v7/main/update.sh && chmod +x update.sh && ./update.sh</code></pre>
...
- Xray Core by [@ALVIICELL](https://github.com/ALVIICELL)
- Penambahan fail2ban
